...
const RestaurantHead = ({Name,cuisines,areaName,Rating,cloudinaryImageId,costForTwoMessage,city,totalRatingsString,message,maxDeliveryTime})=>{
   ...
   return(
    ...
    <img className=" px-6 rounded-lg object-cover"src= {"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/"+cloudinaryImageId} />
    </div>
