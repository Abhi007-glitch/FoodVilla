const MenuCard = ({name,price,description,cloudinaryImageId,isVeg})=>{
  ...
  return (<div className=" w-1/2 flex p-4 m-2 drop-shadow-lg  justify-between border rounded-xl border-gray-200  focus-within:shadow-lgcard  bg-base-100 ">
    ...
    <div className="hover:focus-visible:">
      <img className="w-64 h-44 max-w-none md:w-48 md:h-32 sm:w-32 sm:h-24 object-cover" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_1024/"+cloudinaryImageId} />
    </div>
  </div>);
